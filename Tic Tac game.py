...
reset_btn = Button(window, text="Reset", bg="green", fg="black", width=5, height=1, font=('Helvetica', '12'), command=reset_game)
reset_btn.grid(column=3, row=7)
closeb = Button(window, text="Colse", bg="red", fg="black", width=5, height=1, font=('Helvetica', '12'), command=close)
closeb.grid(column=1, row=7)
